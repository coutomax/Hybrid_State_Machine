...
# Features
    ...
    * Has a parent like behavior, not exatly a hierarchy, but something between Hierarchical and a simple<br>Finite State Machine, with a fixed state named "parent".
